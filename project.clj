(defproject pik-logistic-charts "0.1.0-SNAPSHOT"
  ...
  :profiles {:dev {:dependencies [[binaryage/devtools "0.9.8"]
                   ...
                   :cljsbuild
                                 {:builds {:client {:source-paths ["src" "dev"]
                                                    ...
                                                    :figwheel {:on-jsload "pik-logistic-charts.core/mount-root"}}}}}
  ...
  :cljsbuild {:builds {:client {:compiler {:main pik-logistic-charts.core
